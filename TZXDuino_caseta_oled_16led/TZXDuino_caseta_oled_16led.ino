/*
 * Nicu FLORICA (niq_ro) added 16leds control via 2 x SHRs (595) based on schematic of FACE from https://github.com/tebl/8BIT-Wave 
 * 
 */
...
#define VERSION "TZXDuino 1.16LED"
...
// SHRs pins for control the leds for 8bit-wave board
#define SDATA  8
#define SCLK   4
#define SLATCH 2
...
ShiftRegister74HC595<2> sr(SDATA, SCLK, SLATCH); 
byte k = 0;
int j = 0;
byte mod = 1;
